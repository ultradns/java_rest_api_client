...
import biz.neustar.ultra.rest.dto.BaseAdaptiveResponseRecord.ForcedState;
...
public class SLBPoolRDataInfo {
     ...
     */
    public SLBPoolRDataInfo(String description, ForcedState forcedState, Boolean availableToServe,
     ...
     * @param probingEnabled - ProbingEnabled
     */
    public SLBPoolRDataInfo(String description, ForcedState forcedState, Boolean probingEnabled) {
        super();
        this.description = description;
        this.forcedState = forcedState;
        this.probingEnabled = probingEnabled;
    ...
    public final void setForcedState(ForcedState forcedState) {
        this.forcedState = forcedState;
    }
