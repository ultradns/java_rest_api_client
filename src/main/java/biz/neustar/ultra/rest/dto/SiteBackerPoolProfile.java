...
import biz.neustar.ultra.rest.constants.PoolProbeStatus;
import biz.neustar.ultra.rest.constants.UltraRestSharedConstant.Order;
...
public class SiteBackerPoolProfile implements Profile {
    ...
    public SiteBackerPoolProfile(String description, Boolean runProbes, Boolean actOnProbes, Order order,
            Integer maxActive, Integer maxServed, List<SBTCRDataInfo> rdataInfo, List<BackupRecord> backupRecords) {
        super();
