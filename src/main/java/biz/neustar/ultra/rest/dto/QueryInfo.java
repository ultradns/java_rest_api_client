...
public class QueryInfo {
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add("q", getQ())
                .add("sort", getSort())
    ...
    public final boolean equals(final Object obj) {
        ...
        isEqual =  Objects.equal(getQ(), other.getQ())
                && Objects.equal(getSort(), other.getSort())
                && Objects.equal(isReverse(), other.isReverse())
                && Objects.equal(getLimit(), other.getLimit());
        return isEqual;
    }
